...
Starting with versions 3.17 and 1.21 respectively, the https://develocity.ai/[Gradle Enterprise] Gradle plugin and Maven extension are available under the “Develocity” brand.
